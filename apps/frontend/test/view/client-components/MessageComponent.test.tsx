...
describe('Message Component', () => {
  describe('Text message rendering', () => {
    it('renders user text message with correct prefix', () => {
      ...
      render(<Message role="user" parts={[textPart]} isAnimating={false} />)
    ...
    it('renders AI text message with correct prefix', () => {
      ...
      render(<Message role="assistant" parts={[textPart]} isAnimating={false} />)
    ...
    it('renders multiple text parts correctly', () => {
      ...
      render(<Message role="assistant" parts={parts} isAnimating={false} />)
    ...
    it('applies correct background color for user messages', () => {
      ...
      const { container } = render(<Message role="user" parts={[textPart]} isAnimating={false} />)
    ...
    it('applies correct background color for AI messages', () => {
      ...
      const { container } = render(
        <Message role="assistant" parts={[textPart]} isAnimating={false} />
      )
      const box = container.querySelector('.MuiBox-root')
      expect(box).toBeInTheDocument()
    })
  ...
  describe('Tool: writeFile', () => {
    it('renders writeFile tool with path and content', () => {
      ...
      render(<Message role="assistant" parts={[writeFilePart]} isAnimating={false} />)
  ...
  describe('Tool: readFile', () => {
    it('renders readFile tool with path', () => {
      ...
      render(<Message role="assistant" parts={[readFilePart]} isAnimating={false} />)
  ...
  describe('Tool: deletePath', () => {
    it('renders deletePath tool with path', () => {
      ...
      render(<Message role="assistant" parts={[deletePathPart]} isAnimating={false} />)
  ...
  describe('Tool: listDirectory', () => {
    it('renders listDirectory tool with path', () => {
      ...
      render(<Message role="assistant" parts={[listDirPart]} isAnimating={false} />)
  ...
  describe('Tool: createDirectory', () => {
    it('renders createDirectory tool with path', () => {
      ...
      render(<Message role="assistant" parts={[createDirPart]} isAnimating={false} />)
  ...
  describe('Tool: exists', () => {
    it('renders exists tool with path', () => {
      ...
      render(<Message role="assistant" parts={[existsPart]} isAnimating={false} />)
  ...
  describe('Tool: searchFiles', () => {
    it('renders searchFiles tool with pattern', () => {
      ...
      render(<Message role="assistant" parts={[searchFilesPart]} isAnimating={false} />)
  ...
  describe('Mixed content rendering', () => {
    it('renders text and tool parts together', () => {
      ...
      render(<Message role="assistant" parts={mixedParts} isAnimating={false} />)
    ...
    it('renders multiple tool parts', () => {
      ...
      render(<Message role="assistant" parts={multipleToolParts} isAnimating={false} />)
      expect(screen.getByText(/📖 Read file/)).toBeInTheDocument()
      expect(screen.getByText(/📝 Wrote to file/)).toBeInTheDocument()
    })
  })
