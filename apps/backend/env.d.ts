...
declare module 'varlock/env' {
  ...
  export interface PublicTypedEnvSchema extends Readonly<Pick<CoercedEnvSchema, 'POSTGRES_USER' | 'POSTGRES_DB' | 'POSTGRES_INITDB_ARGS' | 'DATABASE_URL' | 'DATABASE_SSL_ENABLED' | 'DATABASE_SSL_REJECT_UNAUTHORIZED' | 'DATABASE_CONNECTION_TIMEOUT_MS' | 'DATABASE_IDLE_TIMEOUT_MS' | 'DATABASE_POOL_MAX' | 'DATABASE_POOL_MIN' | 'DATABASE_POOL_MAX_LIFETIME_SECONDS' | 'USE_HTTPS' | 'NODE_ENV' | 'PORT' | 'HOST' | 'JWT_ISSUER' | 'JWT_EXPIRATION' | 'LOG_LEVEL' | 'API_VERSION' | 'MODEL_NAME' | 'EMAIL_FROM_ADDRESS' | 'UPSTASH_REDIS_REST_URL' | 'SENTRY_DSN' | 'SENTRY_ENABLED' | 'SENTRY_ORG' | 'SENTRY_PROJECT' | 'CLOUDFLARE_ACCESS_ID' | 'CLOUDFLARE_API' | 'CLOUDFLARE_ENDPOINT' | 'BUCKET' | 'ENCRYPTION_KEY' | 'REFRESH_TOKEN_EXPIRATION' | 'ACCESS_TOKEN_BUFFER' | 'OTEL_CAPTURE_QUERY_TEXT' | 'ALLOWED_ORIGINS' | 'APP_VERSION' | 'SERVICE_NAME'>> {}
}
