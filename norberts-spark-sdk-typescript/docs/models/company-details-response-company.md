...
| `legalName`      | _string_                                                                                      | :heavy_check_mark: | Legal name of the company                          | Acme Corporation Ltd.                |
| `displayName`    | _string_                                                                                      | :heavy_check_mark: | Display name of the company                        | Acme Corp                            |
...
| `timezone`       | _string_                                                                                      | :heavy_check_mark: | Company timezone                                   | America/New_York                     |
