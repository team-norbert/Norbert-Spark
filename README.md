...
Due to slow NextJS, the E2E tests use a production build rather than a development build.
...
The backend is built with Fastify and follows Hexagonal Architecture (Ports and Adapters) principles.
